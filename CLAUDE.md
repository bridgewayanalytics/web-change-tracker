...
| File | Purpose |
|------|---------|
| `eval/run_doc_eval.py` | Entry point — deduplicates by `agent_call_id` (takes most recent row per call), calls `evaluate_doc_row()`, writes results via `store_doc_eval_results()`. |
